 ...
 * Migration: das frühere `source: 'own'` wird zu `'verbatim'`; fehlende
 * Felder (aiBasis/topic/…) werden mit Defaults aufgefüllt.
 */
...
export const settingsRepo = {
  /** Hat der Nutzer den Eigenverantwortungs-Hinweis zur externen Quelle akzeptiert? */
